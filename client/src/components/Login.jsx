      ...
      <div className="w-[400px] h-auto flex flex-col items-center p-2 m-auto">
        <div className="bg-gray-200 flex flex-col items-center justify-center p-6 rounded-lg shadow-zinc-500 shadow-lg">
          ...
          <form className='flex flex-col items-start'>
            ...
            <button className='w-full my-4 p-2 rounded-md text-white font-semibold bg-[#0b446c] hover:bg-[#0d5182] active:bg-[#0d5182]'>Log In</button>
          </form>
        </div>
        <div className='my-4 py-2'>
          <p className='text-lg'>Don&apos;t have an account.<span>
            <Link className='font-semibold text-blue-700' to={"/signup"}>Create</Link>
          </span> here.</p>
        </div>
